      ...
      <div class="container">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder="Ingrese Nombre">
            </div>
            <div class="form-group">
                <label style="float:left;">Email</label>
                <input type="mail" class="form-control"  placeholder="Ingrese Mail">
            </div>
            <div class="form-group">
                <label style="float:left;" >Pregunta</label>
                <textarea type="mail" class="form-control"  placeholder="Ingrese Mail"></textarea>
            </div>
