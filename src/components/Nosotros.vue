  ...
  <div id="app">
      ...
      <div class="container contenedor" style="padding-top=30px;">
        <div class="map">
              ...
              <br>
              <br>
              <p><strong>San Martin 1931, Concepcion del Uruguay</strong>  </p>
        </div>
        <div class="mail">
              <img src="../assets/Nosotros/mail.png">
              <br>
              <br>
              <p><strong> telnovo20@gmail.com</strong> </p>
        </div>
        <div class="wsp">
              <img src="../assets/Nosotros/wsp.png">
              <br>
              <br>
              <p><strong> 3442507780</strong> </p>
